...
class DesktopRegisterRequest(BaseModel):
    """Register or trust a web/desktop companion for QR pairing."""
    desktop_device_id: str
    device_name: str = "Jarvis Desktop"
    platform: str = "web"


class QrPairConsumeRequest(BaseModel):
    """Android QR scan completion payload."""
    pairing_secret: str
    mobile_device_id: str
    device_name: str = "Jarvis Phone"
...
class PlatformBridgeMessage(BaseModel):
    """Unified message record from any bridge (Telegram, Discord, etc.)."""
    message_id: str = Field(default_factory=gen_id)
...
class FocusModeSession(BaseModel):
    """A recorded Focus Mode session with queued messages and summary."""
    session_id: str = Field(default_factory=gen_id)
    note: str = ""
    duration_minutes: Optional[int] = None
    activated_at: datetime = Field(default_factory=now_ts)
