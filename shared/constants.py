...
class EventType(str, Enum):
    ...
    # Platform Bridge Events
    DISCORD_MESSAGE = "discord_message"
    TELEGRAM_MESSAGE = "telegram_message"
    FOCUS_MODE_ACTIVATED = "focus_mode_activated"
    FOCUS_MODE_DEACTIVATED = "focus_mode_deactivated"
    RESEARCH_SWARM_COMPLETED = "research_swarm_completed"
    CHAOS_TEST_COMPLETED = "chaos_test_completed"
