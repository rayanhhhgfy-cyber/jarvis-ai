...
# NOTE: backend.config may not be available when running as a standalone
# desktop daemon. Fall back gracefully.
try:
...
class WakeWordDetector:
    ...
    async def _detection_loop(self) -> None:
        ...
        access_key = settings.picovoice_access_key if _HAVE_SETTINGS else None
