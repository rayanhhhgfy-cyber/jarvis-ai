...
class VisionService:
    ...
    async def _call_openrouter_vision(self, base64_image: str, prompt: str) -> str:
        """Performs the POST request to OpenRouter Chat API."""
        ...
        async with httpx.AsyncClient(timeout=90.0) as client:
            try:
                ...
                if not choices:
                    ...
                    return "Error: No choices returned from vision model"
                ...
                return f"Error: Vision API HTTP Request failed: {str(he)}"
